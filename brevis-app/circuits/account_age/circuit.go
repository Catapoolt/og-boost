...
type AccountAgeCircuit struct{}

func (c *AccountAgeCircuit) Allocate() (maxReceipts, maxStorage, maxTransactions int) {
...
func (c *AccountAgeCircuit) Define(api *sdk.CircuitAPI, in sdk.DataInput) error {
